...
.e1e2JPIR<-function(intranges, jcounts)
{
  ...
  jranges<-sort(jranges) #we have junctions coordenates equal to introns cordenates
  ############################################################
  jInt=findOverlaps(jranges, intranges, type="equal") #junctions equal introns bins
