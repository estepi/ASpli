...
<<featuresAccesors, echo=TRUE, eval=FALSE>>=
...
<<accesorsFamil1, echo=TRUE, eval=FALSE>>=
...
<<AsAccesors, echo=TRUE, eval=FALSE>>=
irPIR<-irPIR(as)
altPSI<-altPSI(as)
esPSI<-esPSI(as)
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.5\textwidth]{testPlots/LRR1_E005.png}
